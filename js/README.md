# Hanzo Manager: Frontend (js)

This directory contains the JavaScript frontend implementation for Hanzo Manager, providing the user interface components that interact with the backend API.

## Core Components

- **hanzo-studio-manager.js**: Main entry point that initializes the manager UI and integrates with Hanzo Studio.
...
- **hanzo-studio-share-common.js**: Base functionality for workflow sharing features.
- **hanzo-studio-share-copus.js**: Integration with the Hanzo Studio Copus sharing platform.
- **hanzo-studio-share-openart.js**: Integration with the OpenArt sharing platform.
- **hanzo-studio-share-youml.js**: Integration with the YouML sharing platform.
...
1. **Integration Layer**: Connects with Hanzo Studio's existing UI system
...
- The frontend integrates directly with Hanzo Studio's UI system through `app.js`
...
This frontend implementation provides a comprehensive yet user-friendly interface for managing the Hanzo Studio ecosystem.
