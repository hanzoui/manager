...
```
** User directory: /path/to/Hanzo Studio/user
** Hanzo Manager config path: /path/to/Hanzo Studio/user/__manager/config.ini
```
...
[Hanzo Manager] NOTICE: Legacy backup exists
  - Your old Manager data was backed up to:
      /path/to/Hanzo Studio/user/__manager/.legacy-manager-backup
...
[Hanzo Manager] ERROR: Suspicious path detected!
  ...
  - Please verify manually:
      /path/to/Hanzo Studio/user/__manager/config.ini
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
```
